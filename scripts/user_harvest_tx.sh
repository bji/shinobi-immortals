...
# Emits an encoded transaction that performs an entry Ki harvest.
...
Usage: user_harvest_tx.sh <USER_PUBKEY> <GROUP_NUMBER> <BLOCK_NUMBER> <ENTRY_INDEX> <STAKE_ACCOUNT_PUBKEY> \\
                          [<TOKEN_PUBKEY>]
